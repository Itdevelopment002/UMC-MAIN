...
router.get("/addt-commissioner-details/:id", (req, res) => {
  const { id } = req.params;
...
router.post("/addt-commissioner-details", upload.single("coImage"), (req, res) => {
...
router.put("/addt-commissioner-details/:id", upload.single("coImage"), (req, res) => {
  const { id } = req.params;
  const { coName, designation, qualification, address, number, email, language_code } = req.body;
...
router.delete("/addt-commissioner-details/:id", (req, res) => {
  const { id } = req.params;
