...
const PublicHealthDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Public Health Department" : "सार्वजनिक आरोग्य विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('publicHealthDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('publicHealthDept.highlight')}</span>
            <span className="highlighted-text"> {t('publicHealthDept.highlight-text')}</span>
            <hr />
          </h2>
