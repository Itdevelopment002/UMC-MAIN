      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="environment-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('estateDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('estateDept.highlight')}</span>
            <span className="highlighted-text"> {t('estateDept.highlight-text')}</span>
            <hr />
          </h2>
