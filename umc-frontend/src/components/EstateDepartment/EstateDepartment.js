...
import banner from '../../assets/images/Departments/Estate department.jpg'

const employeesData1 = [
  { title: "List of Municipal Properties", link: "https://drive.google.com/file/d/1DMrFMFNvJn3BC3aXb9YQ_zohhCea6K9d/view?usp=drive_link", action: "View PDF", },
];

const ITEMS_PER_PAGE = 10;

const EstateDepartment = () => {
  ...
  return (
    <>
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="estate-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Estate Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">Estate</span>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Sanjay Vaydande, Mrs. Alka Pawar</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Estate Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
...
export default EstateDepartment;
