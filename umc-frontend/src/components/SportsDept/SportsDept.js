...
import banner from '../../assets/images/Departments/sports.jpeg';
...
const SportsDept = () => {
  ...
  return (
    <>
      {/* <div className="sport-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="sport-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Sports Department</span>
          </nav>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Shantaram Choudhari</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Sports Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9158494974</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
