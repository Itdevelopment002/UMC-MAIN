...
const SportsDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Sports Department" : "क्रीडा विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('sportsDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('sportsDept.highlight')}</span>
            <span className="highlighted-text"> {t('sportsDept.highlight-text')}</span>
            <hr />
          </h2>
