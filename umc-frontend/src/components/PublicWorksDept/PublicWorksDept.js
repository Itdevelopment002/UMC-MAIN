...
const PublicWorksDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Public Works Department" : "सार्वजनिक बांधकाम विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('worksDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('worksDept.highlight')}</span>
            <span className="highlighted-text"> {t('worksDept.highlight-text')}</span>
            <hr />
          </h2>
...
export default PublicWorksDept;
