...
import banner from '../../assets/images/Departments/handicap.jpg';

const employeesData1 = [
  { title: "List of Beneficiary - Parents of handicapped children", link: "https://drive.google.com/file/d/16TmGAIWY3XbMpkwByoTLzLUqU849UUmE/view?usp=drive_link", action: "View PDF", },
  { title: "Handicapped Pension Details 2019_2020", link: "https://drive.google.com/file/d/1QvqSctBTGCsLWsfINDwPxEshiXM3-jHT/view?usp=drive_link", action: "View PDF", },
  { title: "Handicapped Pension and Mahila Bachat Gat Scheme 2019", link: "https://drive.google.com/file/d/1HdwJiqxTJFxnvOrYdd6XUYbfQgYg7N7J/view?usp=drive_link", action: "View PDF", },
];
...
const HandicapWelfareScheme = () => {
  ...
  return (
    <>
      ...
      {/* <div className="handicap-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="handicap-css">
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Rajesh Ghanghav</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Handicap Welfare Scheme</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9503838182</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
