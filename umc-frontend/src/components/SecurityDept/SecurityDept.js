...
import banner from '../../assets/images/Departments/security.jpeg';
...
const SecurityDept = () => {
  ...
  return (
    <>
      {/* <div className="security-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="security-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Security Department</span>
          </nav>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Yashwant Sagale</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Security Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9324790560</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
