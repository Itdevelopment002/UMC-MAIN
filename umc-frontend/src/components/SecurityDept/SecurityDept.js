...
const SecurityDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Security Department" : "सुरक्षा विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('securityDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('securityDept.highlight')}</span>
            <span className="highlighted-text"> {t('securityDept.highlight-text')}</span>
            <hr />
          </h2>
