...
const EnvironmentDepartment = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Environment Department": "पर्यावरण विभाग"
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="environment-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('environmentDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('environmentDept.highlight')}</span>
            <span className="highlighted-text"> {t('environmentDept.highlight-text')}</span>
            <hr />
          </h2>
