...
import banner from '../../assets/images/Departments/lbt.jpg';
...
const LBTDepartment = () => {
  ...
  return (
    <>
      ...
      {/* <div className="lbt-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="lbt-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">LBT Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">LBT</span>
          ...
          <div className="row mt-4">
            <div className="col-12">
              <ul className="dept-custom-list">
                <li>Any goods imported within the LBT limits are intended for consumption, use or sale in the municipal area, the LBT officer shall, after checking and on being satisfied as to correctness of the description, number, quantity, weight, measure and value of the goods as given in the declaration or otherwise by determining those matters as provided in the rules, assess the amount of LBT payable and demand its payment. On payment being made, the LBT officer shall grant a receipt for the payment, given date and time to issue to the importer or his representative.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Manoj Jadhav</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of LBT Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9320911999</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
