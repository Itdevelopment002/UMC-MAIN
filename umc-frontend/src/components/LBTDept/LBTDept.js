      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="lbt-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('lbtDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('lbtDept.highlight')}</span>
            <span className="highlighted-text"> {t('lbtDept.highlight-text')}</span>
            <hr />
          </h2>
