...
const LegalDepartment = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Legal Department" : "विधी विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="legal-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('legalDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('legalDept.highlight')}</span>
            <span className="highlighted-text"> {t('legalDept.highlight-text')}</span>
            <hr />
          </h2>
