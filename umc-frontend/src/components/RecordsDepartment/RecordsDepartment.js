...
const RecordsDepartment = () => {
  ...
  return (
    <>
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="records-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('recordsDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('recordsDept.highlight')}</span>
            <span className="highlighted-text"> {t('recordsDept.highlight-text')}</span>
            <hr />
          </h2>
...
export default RecordsDepartment;
