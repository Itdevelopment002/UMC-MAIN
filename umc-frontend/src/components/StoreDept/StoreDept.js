...
import banner from '../../assets/images/Departments/Store Department 2.jpg'
...
const StoreDept = () => {
  ...
  return (
    <>
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="store-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Store Department</span>
          </nav>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Ankush Kadam</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Store Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9822879970</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
