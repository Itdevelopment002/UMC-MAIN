...
const PublicRelationshipDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Public Relationship Department" : "जनसंपर्क विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="relationship-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('relationshipDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('relationshipDept.highlight')}</span>
            <span className="highlighted-text"> {t('relationshipDept.highlight-text')}</span>
            <hr />
          </h2>
