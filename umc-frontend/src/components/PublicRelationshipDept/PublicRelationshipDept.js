...
import "./PublicRelationshipDept.css";
...
import banner from '../../assets/images/Departments/relationship.jpg';
...
const PublicRelationshipDept = () => {
  ...
  return (
    <>
      {/* <div className="relationship-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="relationship-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Public Relationship Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">Public</span>
            <span className="highlighted-text"> Relationship Department</span>
            <hr />
          </h2>
          <div className="row mt-4">
            <div className="col-12">
              <ul className="dept-custom-list">
                <li>To publish advertisements, press releases, notifications, and circulars related to various departments.</li>
                <li>To arrange cultural programs.</li>
                <li>To publish notice of General Body meeting.</li>
                <li>To provide publicity for strategic decisions and future planning of the Corporation.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mrs. Chhaya Prakash Dangle</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Public Relationship Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value">
                          {" "}
                          Ground Floor, Public Works Department, Head Quarter of Ulhasnagar Municipal Corporation, Ulhasnagar - 3.
                        </span>
                      </div>
                    </div>
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9158271932 / 0251 – 2720116</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> proumc321@gmail.com</span>
                      </div>
                    </div>
                  </div>
                </div>
...
export default PublicRelationshipDept;
