...
const WaterSupplyDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Water Supply Department" : "पाणीपुरवठा विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('waterDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('waterDept.highlight')}</span>
            <span className="highlighted-text"> {t('waterDept.highlight-text')}</span>
            <hr />
          </h2>
