...
const CensusDepartment = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Census & Aadhar Center" : "जनगणना आणि आधार केंद्र"
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('census.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('census.highlight')}</span>
            <span className="highlighted-text"> {t('census.highlight-text')}</span>
            <hr />
          </h2>
...
export default CensusDepartment;
