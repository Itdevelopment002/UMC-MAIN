...
const ElectionDepartment = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Election Department": "निवडणूक विभाग"
  ...
  return (
    <>
      ...
      {/* <div className="election-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="election-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('electionDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('electionDept.highlight')}</span>
            <span className="highlighted-text"> {t('electionDept.highlight-text')}</span>
            <hr />
          </h2>
...
export default ElectionDepartment;
