...
import banner from '../../assets/images/Departments/vaidyakiya arogya vibhag.jpg'
...
const MedicalHealthDept = () => {
  ...
  return (
    <>
      {/* <div className="medical-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="medical-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Medical Health Department</span>
          </nav>
          ...
          <div className="row mt-4">
            <div className="col-12">
              <ul className="dept-custom-list">
                <li>National Family Welfare Program</li>
                <li>Reproductive and Child Health Program</li>
                <li>Revised National Tuberculosis Control Program</li>
                <li>National Leprosy Eradication Program</li>
                <li>National Malaria Eradication Program</li>
                <li>National Blindness Control Program</li>
                <li>National AIDS Control Program</li>
                <li>Epidemic Control Program</li>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Dr. Mohini Dharma</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Medical Health Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9421548546</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
...
export default MedicalHealthDept;
