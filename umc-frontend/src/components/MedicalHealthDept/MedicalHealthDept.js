...
const MedicalHealthDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Medical Health Department" : "वैद्यकीय आरोग्य विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="medical-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('medicalDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('medicalDept.highlight')}</span>
            <span className="highlighted-text"> {t('medicalDept.highlight-text')}</span>
            <hr />
          </h2>
