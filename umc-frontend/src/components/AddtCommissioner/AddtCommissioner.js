...
const AddtCommissioner = () => {
  ...
  // Function to get all descriptions for a specific commissioner
...
//     try {
//       const response = await api.get(`/addt-commissioner-details?lang=${i18n.language}`);
...
//     try {
//       const response = await api.get(`/addt-commissioner-desc?lang=${i18n.language}`);
...
//         let selectedBanner = response.data.find(banner => banner.banner_name === "Additional Commissioner");
