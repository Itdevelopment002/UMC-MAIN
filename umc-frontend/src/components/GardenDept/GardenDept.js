      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="environment-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('gardenDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('gardenDept.highlight')}</span>
            <span className="highlighted-text"> {t('gardenDept.highlight-text')}</span>
            <hr />
          </h2>
