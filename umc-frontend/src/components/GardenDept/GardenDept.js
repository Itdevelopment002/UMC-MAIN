...
import banner from '../../assets/images/Departments/Garden Department.jpg'
...
const GardenDepartment = () => {
  ...
  return (
    <>
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="garden-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Garden Department</span>
          </nav>
