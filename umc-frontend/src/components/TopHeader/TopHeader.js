...
const TopHeader = () => {
    ...
    const fixMarathiTranslation = () => {
        requestAnimationFrame(() => {
            ...
            replaceTextRecursively(document.body, "कॉर्पोरेशन", "महानगरपालिका");
            replaceTextRecursively(document.body, "नगरपालिका बैठका", "महापालिका सभा");
            replaceTextRecursively(document.body, "यूएमसी बातम्या", "उ. म. पा. बातम्या");
            replaceTextRecursively(document.body, "यूएमसी", "उ. म. पा.");
            replaceTextRecursively(document.body, "मालमत्ता कर भरा", "तुमचा मालमत्ता कर भरा");
            replaceTextRecursively(document.body, "तक्रार नोंदणी", "तुमची तक्रार नोंदवा");
            replaceTextRecursively(document.body, "प्रधानमंत्री आवास योजना", "पीएमएवाय");
            replaceTextRecursively(document.body, "स्वच्छ भारत अभियान", "स्वच्छ भारत");
           
            replaceTextRecursively(document.body, "राष्ट्रीय स्वच्छ वायू कार्यक्रम", "एनसीएपी");
