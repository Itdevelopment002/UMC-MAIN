...
import "./MarketLicensingDept.css";
...
import banner from '../../assets/images/Departments/market.jpg'
...
const MarketLicensingDept = () => {
  ...
  return (
    <>
      ...
      {/* <div className="market-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="market-css">
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Market and Licensing Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
...
export default MarketLicensingDept;
