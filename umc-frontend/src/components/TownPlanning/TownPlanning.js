...
const TownPlanning = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Town Planning Department" : "नगररचना विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('townDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('townDept.highlight')}</span>
            <span className="highlighted-text"> {t('townDept.highlight-text')}</span>
            <hr />
          </h2>
