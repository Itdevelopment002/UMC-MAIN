      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('nulmDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('nulmDept.highlight')}</span>
            <span className="highlighted-text"> {t('nulmDept.highlight-text')}</span>
            <hr />
          </h2>
