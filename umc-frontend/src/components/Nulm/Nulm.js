...
import banner from "../../assets/images/Departments/nulm.jpg"
...
const employeesData1 = [
  { title: "NULM UMC", link: "https://drive.google.com/file/d/1fYHlu9QEFPcR85kgt7Oqp63LptYfQGZc/view?usp=drive_link", action: "View PDF", },
];
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="nulm-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">NULM Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">NULM</span>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of NULM Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
