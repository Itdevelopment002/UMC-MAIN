...
const SolidWasteManagementDept = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Solid Waste Management Department" : "घनकचरा व्यवस्थापन विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('swmDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('swmDept.highlight')}</span>
            <span className="highlighted-text"> {t('swmDept.highlight-text')}</span>
            <hr />
          </h2>
