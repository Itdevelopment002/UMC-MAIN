...
import "./SolidWasteManagementDept.css";
...
import banner from '../../assets/images/Departments/Public Health and Solid Waste Management 2.jpg';
...
const SolidWasteManagementDept = () => {
  ...
  return (
    <>
      {/* <div className="waste-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="waste-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Solid Waste Management Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">Solid</span>
            <span className="highlighted-text"> Waste Management Department</span>
            <hr />
          </h2>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Solid Waste Management Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
...
export default SolidWasteManagementDept;
