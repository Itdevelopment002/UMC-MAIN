...
const VehicleDepartment = () => {
  ...
  const department_name = (i18n.language === 'en') ? "Vehicle Department" : "वाहन विभाग"
      ...
      <div id="main-content">
        ...
        <div className="container-fluid font-location mt-4 mb-2" id="accounts-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('vehicleDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('vehicleDept.highlight')}</span>
            <span className="highlighted-text"> {t('vehicleDept.highlight-text')}</span>
            <hr />
          </h2>
