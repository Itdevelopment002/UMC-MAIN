...
import banner from '../../assets/images/Departments/vahan vibhag.jpg'

const employeesData1 = [
  { title: "Vehicle RTI", link: "https://drive.google.com/file/d/1-uAEWfFV5k52bZd2gbneosl-d9JE-_WA/view?usp=drive_link", action: "View PDF", },
];
...
const VehicleDepartment = () => {
  ...
  return (
    <>
      {/* <div className="vehicle-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="vehicle-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Vehicle Department</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">Vehicle</span>
          ...
          <div className="row mt-4">
            <div className="col-lg-3 col-md-4 col-sm-12 col-12">
              <div className="dept-profile-card text-center">
                ...
                />
                <p className="dept-custom-title">Mr. Vinod Kene</p>
              </div>
            </div>
                  ...
                  <div className="dept-col">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> 9702966333</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
