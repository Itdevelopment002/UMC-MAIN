...
import banner from '../../assets/images/Departments/education.jpeg';
...
const EducationDepartment = () => {
  ...
  return (
    <>
      ...
      {/* <div className="education-header-image"></div> */}
      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="education-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">Education Department</span>
          </nav>
                  ...
                  <div className="dept-col">
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> Head of Education Department</span>
                      </div>
                    </div>
                    <div className="dept-item">
                      <div className="dept-icon-box">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value">
                          {" "}
                          Main Building, 3rd Floor, Near Chopra Court, Ulhasnagar - 421 003
                        </span>
                      </div>
                    </div>
                    <div className="dept-item">
                    ...
                    <div className="dept-item">
                      ...
                      <div className="dept-text-box">
                        ...
                        <span className="dept-value"> educationdept.ulhasnagar@gmail.com </span>
                      </div>
                    </div>
                  </div>
                </div>
