      ...
      <div id="main-content">
        <div className="container-fluid font-location mt-4 mb-2" id="education-css">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-item active1">{t('educationDept.title')}</span>
          </nav>
          <h2 className="location-title">
            <span className="highlight">{t('educationDept.highlight')}</span>
            <span className="highlighted-text"> {t('educationDept.highlight-text')}</span>
            <hr />
          </h2>
