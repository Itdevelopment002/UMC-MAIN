...
const AddSolidWasteSystem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/swms", {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        setLanguage("");
        setIssueDate("");
        toast.success("Solid Waste management System added successfully!", {
          position: "top-right",
          autoClose: 1000,
          onClose: () => {
            navigate("/swms");
      ...
      if (
        ...
        toast.error(
          error.response?.data?.message || "Failed to add swms data. Try again.",
          {
            position: "top-right",
            autoClose: 3000,
          }
      ...
      console.error("Error adding swms data:", error);
    }
  };
        ...
        <div className="content">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active" aria-current="page">
              Add Solid Waste Management System
            </li>
          </ol>
          <div className="row">
...
export default AddSolidWasteSystem;
