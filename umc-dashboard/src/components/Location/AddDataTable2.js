...
const AddDataTable2 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSubmit = { ...formData, type: "Table 2" };
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        toast.success("Table 2 data added successfully!", {
          position: "top-right",
          autoClose: 1000,
          onClose: () => {
            navigate("/location");
      ...
      if (
        ...
        toast.error(
          error.response?.data?.message || "Error adding table 2 data:",
          {
            position: "top-right",
            autoClose: 3000,
          }
      ...
      console.error("Error adding table 2 data:", error);
    }
  };
                ...
                <div className="card-block">
                  <div className="row">
                    <div className="col-12">
                      <h4 className="page-title">Add Table 2 Data</h4>
                    </div>
                  </div>
