...
const DataTable2 = () => {
  ...
  const fetchPolicy = async () => {
    try {
      ...
      toast.error("Failed to fetch table 2 data!");
    }
  };
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.success("Table 2 data deleted successfully!");
    } catch (error) {
      console.error("Error deleting table 2 data:", error);
      toast.error("Failed to delete the table 2 data!");
    }
  };
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Edit Table 2 Data</h5>
              </div>
