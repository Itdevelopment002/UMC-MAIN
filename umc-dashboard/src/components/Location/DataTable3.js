...
const DataTable3 = () => {
  ...
  const fetchPolicy = async () => {
    try {
      ...
      toast.error("Failed to fetch table 3 data!");
    }
  };
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.success("Table 3 data deleted successfully!");
    } catch (error) {
      console.error("Error deleting table 3 data:", error);
      toast.error("Failed to delete the table 3 data!");
    }
  };
  ...
  const handleEditSave = async () => {
    try {
      ...
      toast.success("Table 3 data updated successfully!");
    } catch (error) {
      if (
        error.response &&
        ...
        toast.error(
          error.response?.data?.message || "Failed to update the table 3 data!",
          {
            position: "top-right",
            autoClose: 3000,
          }
      ...
      console.error("Failed to update the table 3 data!", error);
    }
  };
  ...
  const totalPages = Math.ceil(
    policyData.filter((policy) => policy.type === "Table 3").length / itemsPerPage
  );
        ...
        <div className="col-lg-12">
          <div className="card-box">
            <div className="card-block">
              <div className="row">
                <div className="col-6">
                  <h4 className="page-title">Table 3 Data</h4>
                </div>
                <div className="col-6 text-right m-b-20">
                  <Link
                    to="/add-datatable3"
                    onClick={() => handleLinkClick("Table 3")}
                    className="btn btn-primary btn-rounded float-right"
                  >
                    <i className="fa fa-plus"></i> Add Data 3
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Edit Table 3 Data</h5>
              </div>
