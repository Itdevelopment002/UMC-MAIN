...
const Resolutions = () => {
    ...
    const handleDelete = async () => {
        try {
            await api.post(`/delete-resolution/${selectedResolution.Sr_No}`);
            setResolutions(
            ...
            toast.error("Failed to delete the resolution!");
        }
    };
    ...
    const handleEditSave = async () => {
        try {
            const formattedPublishDate = selectedResolution.Schedule_Date_of_Meeting
                ...
                : "";
            await api.post(`/edit-resolution/${selectedResolution.Sr_No}`, {
            ...
            if (
                ...
                toast.error(
                    error.response?.data?.message || "Failed to update resolution data. Try again.",
                    {
                        position: "top-right",
                        autoClose: 3000,
                    }
            ...
            console.error("Error updating resolution data:", error);
        }
    };
                                ...
                                <div className="card-block">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-8 col-9 text-right m-b-20">
                                            ...
                                            >
                                                <i className="fa fa-plus"></i> Add Resolution
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                        <form>
                                            ...
                                            <div className="mb-3">
                                                <label className="form-label">Resolution No/Date</label>
                                                <input
                                                    type="text"
                                                    className="form-control"
                                                    name="Resolutions_No_Date"
                                                    value={selectedResolution?.Resolutions_No_Date || ""}
                                                    onChange={handleEditChange}
                                                />
                                            </div>
                                            <div className="mb-3">
