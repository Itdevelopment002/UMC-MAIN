...
//         try {
//             const response = await api.get("/addt-commissioner-desc");
//             setDescData(response.data);
//         } catch (error) {
//             toast.error("Failed to fetch Additional Commissioner description data!");
//         }
//     };

//     const fetchCoData = async () => {
//         try {
//             const response = await api.get("/addt-commissioner-details");
...
//         try {
//             if (type === "history") {
//                 await api.delete(`/addt-commissioner-desc/${id}`);
//                 setDescData((prevData) => prevData.filter((item) => item.id !== id));
//             } else if (type === "co") {
//                 await api.delete(`/addt-commissioner-details/${id}`);
//                 setCoData((prevData) => prevData.filter((item) => item.id !== id));
//             }
//             toast.success(
//                 `Additional Commissioner Information deleted successfully!`
//             );
//         } catch (error) {
//             console.error(error);
...
//                 await api.put(`/addt-commissioner-details/${selectedItem.id}`, formData, {
//                     headers: {
...
//                                                 ) : (
//                                                     <tr>
//                                                         <td colSpan="9" className="text-center">No Additional Commissioner Details Available</td>
//                                                     </tr>
//                                                 )}
//                                             </tbody>
//                                         </table>
...
//                                                 ) : (
//                                                     <tr>
//                                                         <td colSpan="3" className="text-center">No Additional Commissioner Description Available</td>
//                                                     </tr>
//                                                 )}
//                                             </tbody>
//                                         </table>
...
//                                             {modalType === "history"
//                                                 ? "Edit Addt. Commissioner Description"
//                                                 : "Edit Addt. Commissioner Details"}
//                                         </h5>
//                                     </div>
...
const AddtCommissioner = () => {
    ...
    const handleDelete = async (id, type) => {
        try {
            const endpoint = type === "history" 
                ? `/addt-commissioner-desc/${id}` 
                : `/addt-commissioner-details/${id}`;
    ...
    const handleSaveChanges = async () => {
        try {
            if (modalType === "history") {
                await api.put(`/addt-commissioner-desc/${selectedItem.id}`, editData);
                fetchData();
