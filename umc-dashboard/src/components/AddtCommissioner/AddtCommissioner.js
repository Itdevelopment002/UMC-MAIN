...
const AddtCommissioner = () => {
    ...
    const handleDelete = async (id, type) => {
        try {
            if (type === "history") {
                await api.post(`/delete-addt-commissioner-desc/${id}`);
                setDescData((prevData) => prevData.filter((item) => item.id !== id));
            } else if (type === "co") {
                await api.post(`/delete-addt-commissioner-details/${id}`);
    ...
    const handleSaveChanges = async () => {
        try {
            if (modalType === "history") {
                await api.post(`/edit-addt-commissioner-desc/${selectedItem.id}`, {
