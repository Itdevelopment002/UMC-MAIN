...
//     try {
//       const response = await api.post("/addt-commissioner-desc", formData, {
...
//             </li>
//             <li className="breadcrumb-item active">Add Additional Commissioner Description</li>
//           </ol>
//           <div className="row">
...
// export default AddAddtCommissionerDesc;
...
const AddAddtCommissionerDesc = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/addt-commissioner-desc", {
