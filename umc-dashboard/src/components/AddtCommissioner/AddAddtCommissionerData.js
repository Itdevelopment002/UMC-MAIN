...
const AddAddtCommissionerData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/addt-commissioner-data", data, {
      ...
      <div className="page-wrapper">
        <div className="content">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Add Additional Commissioner Data</li>
          </ol>
          <div className="row">
            <div className="col-lg-12">
              <div className="card-box">
                <h4 className="page-title">Add Additional Commissioner Data</h4>
...
export default AddAddtCommissionerData;
