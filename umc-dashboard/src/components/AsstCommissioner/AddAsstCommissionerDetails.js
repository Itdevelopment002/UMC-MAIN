...
const AddAsstCommissionerDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/asst-commissioner-details", data, {
      ...
      <div className="page-wrapper">
        <div className="content">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Add Assistant Commissioner Details</li>
          </ol>
          <div className="row">
...
export default AddAsstCommissionerDetails;