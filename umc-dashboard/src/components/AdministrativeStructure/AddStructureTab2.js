...
const AddStructureTab2 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await api.post('/structure-tab2', {
            ...
            <div className="page-wrapper">
                <div className="content">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Departments entrusted to the Deputy Commissioner</li>
                    </ol>
                    <div className="row">
...
export default AddStructureTab2;
